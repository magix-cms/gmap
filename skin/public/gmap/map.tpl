{if !empty($addresses)}
    ...
    <div class="map">
        <div>
            <div id="gmap_map" class="gmap3" data-map-id="{if $config.appId != '' AND $config.appId != NULL}{$config.appId}{else}VOTRE_ID_REEL_ICI{/if}"></div>
        </div>
    ...
    <div class="container">
        <div class="mc-message clearfix">
            <p class="alert alert-warning fade in">
                ...
                <span class="ico ico-warning-sign"></span> {#gmap_plugin_error#} : {#gmap_plugin_configured#}
            </p>
        </div>
    </div>
{/if}